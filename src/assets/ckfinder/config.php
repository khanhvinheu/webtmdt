...
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => 'localhost/cdio3_banhang/public/upload/ckfinder',
...
$config['backends'][] = array(
   ...
   'adapter'      => 'dropbox',
   'username'     => 'thanhdungttrd@gmail.com',
   'token'        => 'Kn5-tsRWOGAAAAAAAAABUeGG58dtD1YpYQlbgBykcvxt7IKkDlLY5TJKpjD_lXFh',
